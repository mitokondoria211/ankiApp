...
//	public void login(Model model,@Validated SignupForm form, BindingResult bdResult, RedirectAttributes redirectAttributes) {
...
//		var signupMessageId = judgeMessageKey(userInfoOpt);
//		editGuideMessage(model, signupMessageId.getMessageId(), signupMessageId.isError());
//	}
...
//		String message = AppUtility.getMessage(messageSource, messageId);
